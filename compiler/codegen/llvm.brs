...
(defn llvm-header [triple with-tls]
  (let [t (if (> (count triple) 0) triple "x86_64-unknown-linux-gnu")
    ...
    (do (lines-push lines (str-concat "target triple = \"" (str-concat t "\"")))
        ...
        (lines-push lines "declare i64 @bars_string_upper(i64)")
        (lines-push lines "declare i64 @bars_string_lower(i64)")
        (lines-push lines "declare i64 @bars_string_eq_i64(i64, i64)")
        ...
        (lines-push lines "declare i64 @bars_vector_set_i64(i64, i64, i64)")
        (lines-push lines "declare i64 @bars_flatten_i64(i64)")
        (lines-push lines "declare i64 @bars_abs_i64(i64)")
        (lines-push lines "declare i64 @bars_sqrt_i64(i64)")
        (lines-push lines "declare i64 @bars_pow_i64(i64, i64)")
        (lines-push lines "declare i64 @bars_map_delete_i64(i64, i64)")
        ...
        (lines-push lines "declare i64 @bars_set_count_i64(i64)")
        ...
        (if with-tls
          (do (lines-push lines "declare i64 @bars_tls_connect(i64, i64, i64)")
              ...
              (lines-push lines "declare i64 @bars_tls_listen(i64, i64, i64)")
              (lines-push lines "declare i64 @bars_tls_accept(i64)")
              (lines-push lines "declare i64 @bars_tls_server_close(i64)"))
          0)
                      ...
                      (if (str-eq? fname "vector-set") "bars_vector_set_i64"
                        (if (str-eq? fname "flatten") "bars_flatten_i64"
                          (if (str-eq? fname "abs") "bars_abs_i64"
                            (if (str-eq? fname "sqrt") "bars_sqrt_i64"
                              (if (str-eq? fname "pow") "bars_pow_i64"
